@if ($paginator->hasPages())
    <nav class="w-100">
        <ul class="pagination mb-0">
            ...
            @else
                <li class="page-item">
                    <a class="page-link btn-md bg-light text-dark" href="{{ $paginator->previousPageUrl() }}#result-board" rel="prev"><i class="fas fa-chevron-left"></i> Previous</a>
                </li>
            @endif
            ...
            @if ($paginator->hasMorePages())
                <li class="page-item">
                    <a class="page-link btn-md bg-light text-dark" href="{{ $paginator->nextPageUrl() }}#result-board" rel="next">Next <i class="fas fa-chevron-right"></i></a>
                </li>
            @else
                <li class="page-item disabled" aria-disabled="true">
